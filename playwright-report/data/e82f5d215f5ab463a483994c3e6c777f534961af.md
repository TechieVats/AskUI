...
- Name: Chatbot UI Tests >> supports RTL rendering for Arabic responses
- Location: /Users/abhishek.vats/Documents/Projects Git/Projects/AskUI_Assessment/tests/ui/chatbot-ui.spec.ts:53:9
...
Call log:
  - waiting for locator('.chat-item.chatbot.chat-message-in[data-msgid]') to be visible
    ...
    at /Users/abhishek.vats/Documents/Projects Git/Projects/AskUI_Assessment/tests/ui/chatbot-ui.spec.ts:62:44
```
...
- img
- text: كيف يمكنني تجديد إقامتي؟ 15/6/2025 @ 23:55:59
- img
- img
- dialog:
  - iframe
